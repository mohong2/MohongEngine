...
public class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public void surfaceChanged(SurfaceHolder holder,
        ...
        // Ask the compositor/display to use the panel's preferred refresh rate for this
        // SurfaceView (Android 11+). Without this, some 90/120/144 Hz panels stay at 60 Hz
        // by default, which makes high-refresh frame pacing look erratic.
        if (Build.VERSION.SDK_INT >= 30) {
            try {
                getHolder().getSurface().setFrameRate(mDisplay.getRefreshRate(), Surface.FRAME_RATE_COMPATIBILITY_DEFAULT);
            } catch (Exception ignored) {}
        }
