...
class GameplayChangersSubstate extends ScriptSubstate
{
	...
	public function new()
	{
		...
		for (i in 0...optionsArray.length)
		{
			...
			if(optionsArray[i].type == 'bool') {
				...
				optionText.snapToPosition();
				var valueText:AttachedText = new AttachedText(Std.string(optionsArray[i].getValue()), optionText.width + 35, 0, true, 0.8);
