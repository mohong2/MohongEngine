...
{		
#if PRELOAD_ALL
		var leText:String = "按 SPACE 键收听歌曲 / 按 CTRL 键打开 Gameplay Changers 菜单 / 按 RESET 重置您的分数和准确度。";
		var size:Int = 16;
		#else
		var leText:String = "按 CTRL 打开 Gameplay Changers 菜单/按 RESET 重置您的分数和准确度。";
		var size:Int = 18;
		#end
		var text:FlxText = new FlxText(textBG.x, textBG.y + 4, FlxG.width, leText, size);
		text.setFormat(Paths.font("vcr.ttf"), size, FlxColor.WHITE, RIGHT);
